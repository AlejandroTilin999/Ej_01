        ...
        <div className="hidden lg:flex items-center gap-3">
          <div className="relative group">
            ...
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 bg-white text-sm text-gray-700 px-3 py-2 rounded-xl shadow-lg opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 z-50">
              Próximamente
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-white rotate-45 mt-[-4px] shadow-sm" />
            </div>
          </div>
          <div className="relative group">
            <Button
          ...
          <div className="flex flex-col gap-3 px-6 py-4 items-center">
            <div className="relative group w-full flex justify-center">
              <Button
                ...
                className="pointer-events-none opacity-60 cursor-not-allowed"
              />
              <div className="absolute -bottom-12 bg-white text-sm text-gray-700 px-3 py-2 rounded-xl shadow-lg opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 z-50">
                Próximamente
                <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-white rotate-45 mt-[-4px] shadow-sm" />
              </div>
            </div>
