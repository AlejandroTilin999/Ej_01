...
import RenderDestino from './renders/destino';
import RenderHospedaje from './renders/hopedajeCalendario';
import RenderHoteles from './renders/hoteles';
import RenderHabitaciones from './renders/habitaciones';
import RenderEventos from './renders/eventos';
import RenderFinal from './renders/despedida';
...
const ModalFlujo = React.memo(function ModalFlujo({ show, onClose, categoria, onBack, subCategoria, destino }) {
  ...
  <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 w-full max-w-[614.4px] shadow-xl transform transition-all duration-300">
    {renderPaso()}
  </div>
</div>
  );
