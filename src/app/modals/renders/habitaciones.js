...
export default function RenderHabitaciones({ datos, onSiguiente, onVolver, onClose }) {
  ...
  return (
    <div className="flex flex-col h-[80vh] min-h-[500px] max-h-[800px] w-full max-w-4xl bg-white rounded-lg overflow-hidden shadow-xl">
      {/* Header fijo */}
            ...
            >
              ...
              <div className="p-3">
                ...
                <div className="flex items-center mt-1">
                  ...
                  {habitacion.internet && (
                    <span className="ml-2 text-xs text-[#6A7282] flex items-center">
                ...
                <p className="text-xs text-[#6A7282] mt-2 line-clamp-2">{habitacion.descripcion}</p>
