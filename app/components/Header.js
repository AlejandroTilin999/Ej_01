    ...
    <nav className="fixed w-full bg-white shadow-md z-50">
      <div className="container mx-auto flex items-center justify-between px-6 py-4">
        ...
        <Link href="/" className="flex items-center">
          <Image src="/img/navbar/GoMichoacan.png" alt="Go Michoacán" width={130} height={40} />
        </Link>
        ...
        <div className="hidden lg:flex items-center gap-3">
          <button className="bg-[var(--color-accent)] text-white px-4 py-1.5 rounded-md shadow hover:opacity-85 transition">
            Inicia Sesión
          </button>
          <button className="bg-[var(--color-secondary)] text-white px-4 py-1.5 rounded-md shadow hover:opacity-85 transition">
            Anúnciate
          </button>
        </div>
      </div>
      ...
      <div className={`lg:hidden bg-white absolute w-full left-0 transition-all duration-300 ${isOpen ? 'top-full opacity-100 shadow-lg' : 'top-[-500px] opacity-0 pointer-events-none'}`}>
        ...
        <div className="flex flex-col gap-3 px-6 py-4">
          <button className="bg-[var(--color-accent)] text-white px-4 py-2 rounded-lg shadow hover:opacity-85 transition">
            Inicia Sesión
          </button>
          <button className="bg-[var(--color-secondary)] text-white px-4 py-2 rounded-lg shadow hover:opacity-85 transition">
            Anúnciate
          </button>
        </div>
      </div>
