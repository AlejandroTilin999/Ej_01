...
const Footer = () => {
  return (
    <footer className="bg-primary text-white py-10 w-full">
      <Container className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center md:text-left">
        ...
        <div>
          ...
          <p className="text-sm flex items-center justify-center md:justify-start gap-2 cursor-pointer">
            <span>✉️</span> gomich@gmail.com
          </p>
        </div>
